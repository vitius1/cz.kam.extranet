...
class CRM_Extranet_Page_Mailing extends CRM_Core_Page {

  public function run() {
    // Example: Set the page-title dynamically; alternatively, declare a static title in xml/Menu/*.xml
    CRM_Utils_System::setTitle(E::ts('Mailing'));
        ...
        <div class="region region-sidebar-first custom-menu">
          ...
          <section class="custom-links" style="margin-left: calc(50% - 90px); margin-top: 50px;">
            <ul>
              ...
              <li><a class="custom-active" href="mailing">Zasílání newsletteru</a></li>
  ...
  <script async>
  CRM.$(".custom-form").load("https://crm.kam.cz/formular/mailing form", function(){
